...
namespace Banco_GGAL_App1.Reporte {
    ...
    public partial class DSListado : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientesRow AddClientesRow(string apellido, string nombre) {
...
namespace Banco_GGAL_App1.Reporte.DSListadoTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Clientes] WHERE (([nro_cliente] = @Original_nro_cliente) AND ([apell" +
                "ido] = @Original_apellido) AND ([nombre] = @Original_nombre))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Clientes] SET [apellido] = @apellido, [nombre] = @nombre WHERE (([nro_cliente] = @Original_nro_cliente) AND ([apellido] = @Original_apellido) AND ([nombre] = @Original_nombre));
SELECT nro_cliente, apellido, nombre FROM Clientes WHERE (nro_cliente = @nro_cliente)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-52VGB0T;Initial Catalog=BancoFundido$GGAL;Integrated Security" +
                "=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT nro_cliente, apellido, nombre\r\nFROM     Clientes";
        ...
        public virtual int Fill(DSListado.ClientesDataTable dataTable) {
        ...
        public virtual DSListado.ClientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DSListado.ClientesDataTable dataTable = new DSListado.ClientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DSListado.ClientesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_nro_cliente, string Original_apellido, string Original_nombre) {
        ...
        public virtual int Update(string apellido, string nombre, int Original_nro_cliente, string Original_apellido, string Original_nombre, int nro_cliente) {
            if ((apellido == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Original_nro_cliente));
            if ((Original_apellido == null)) {
                throw new global::System.ArgumentNullException("Original_apellido");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string apellido, string nombre, int Original_nro_cliente, string Original_apellido, string Original_nombre) {
            return this.Update(apellido, nombre, Original_nro_cliente, Original_apellido, Original_nombre, Original_nro_cliente);
        }
    }
